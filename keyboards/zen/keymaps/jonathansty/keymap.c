...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL, _______, KC_LGUI, KC_LALT, LOWER, KC_SPC, _______,  _______,  KC_BSPC,  RAISE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT  \
),
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_LEFT, _______, KC_PGDOWN, KC_PGUP, _______,
  _______, _______, _______, _______, _______, _______, KC_TRNS, KC_TRNS, _______, _______, KC_MNXT, KC_VOLD,   KC_VOLU, KC_MPLY \
),
